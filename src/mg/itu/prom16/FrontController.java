...
public class FrontController extends HttpServlet {
    ...
    private void displayErrorPage(PrintWriter out, int errorCode, String errorMessage, String errorDetails,
        ...
        out.println("<body>");
        out.println("<style>    body {        background-color: #e0988f;    }   .contain_error {        border: solid 2px #e74c3c;        background-color: white;        border-radius: 10px;        padding: 30px;}.title_in {color: rgb(45, 26, 26); }.link_in {color: #279a8e;text-decoration: none;}</style>");
        
        out.println("<div class=\"contain_error\" style='font-family: Arial, sans-serif; max-width: 600px;margin: auto;'>");
        out.println("<h1 style='color: #e74c3c;'>" + errorMessage + "</h1>");
        out.println("<p><strong class=\"title_in\">Code d'erreur :</strong> " + errorCode + "</p>");
        out.println("<p style='color: #cbd720;'>" + errorDetails + "</p>");
        out.println("<p><strong class=\"title_in\">Action demandée :</strong> " + controllerSearched + "</p>");
        out.println("<p><strong class=\"title_in\">Méthode HTTP utilisée :</strong> " + method + "</p>");
